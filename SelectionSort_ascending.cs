...
{
    class SelectionSort_ascending : ISortEngine
    {
        ...
        public SelectionSort_ascending(int[] elements, Graphics graphic, int maximumValue)
        {
            Elements = elements;
        ...
        public void algorithm()
        {
            for (int i = 0; i < Elements.Count() - 1; i++)
            {
                ...
                {
                    if (Elements[j] < Elements[min_item])
                    {
                        min_item = j;
                    }

                    Swapping_items(min_item, i);
                }
